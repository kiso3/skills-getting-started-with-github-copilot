...
activities.update({
    "Soccer Team": {
        "description": "Competitive soccer team practicing skills and playing interschool matches",
    ...
    "Debate Team": {
        "description": "Practice persuasive speaking, research, and compete in debate tournaments",
...
def remove_participant(activity_name: str, email: str):
    ...
    # Check if the participant is in the activity
